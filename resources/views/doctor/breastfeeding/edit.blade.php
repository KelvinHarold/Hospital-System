<x-doctor-layout>
    <div class="max-w-4xl mx-auto mt-10 p-8 bg-white shadow-xl rounded-xl border border-gray-200">
        <div class="flex items-center justify-center mb-6">
            ...
            <h2 class="text-3xl font-bold text-gray-800">Edit Breastfeeding Record</h2>
        </div>

        <form action="{{ route('doctor.breastfeeding.update', $record->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    value="{{ old('breastfeeding_stage', $record->breastfeeding_stage) }}"
                    class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200" 
                    required
                >
